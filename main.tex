...
\usepackage{amsmath,amssymb,caption,subcaption,tikz,pgfplots}
...
\titlecontents{chapter}[0pt]{\addvspace{6pt}\bfseries\color{titleblue}}{\contentslabel[\thecontentslabel]{1.5em}}{}{\hfill\contentspage}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/text_length_boxplots.png}\caption{Text length distribution by class}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/text_shape_scatter.png}\caption{Text length vs. unique word count}\end{subfigure}
\caption{Text shape analysis: ham emails tend to be longer with more unique words than spam.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/ham_wordcloud.png}\caption{Ham vocabulary — business \& conversational terms}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/spam_wordcloud.png}\caption{Spam vocabulary — action-oriented marketing terms}\end{subfigure}
\caption{Wordcloud comparison: ham vs. spam vocabulary reveals distinct lexical signatures.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/label_distribution.png}\caption{Severe class imbalance (73/27)}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab01/raw_vs_clean_length_scatter.png}\caption{Text length before vs. after cleaning}\end{subfigure}
\caption{EDA: class distribution and preprocessing effects}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_003.png}\caption{Target distribution — raw + $\log_{1p}$}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_004.png}\caption{Target boxplot by segments}\end{subfigure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_002.png}\caption{Product family revenue breakdown}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_016.png}\caption{Revenue by category}\end{subfigure}
\caption{Product family analysis: Pareto distribution with top families dominating revenue.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_007.png}\caption{Daily revenue rolling mean — trend}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_008.png}\caption{Monthly revenue patterns}\end{subfigure}
\caption{Trend and seasonality: gradual growth trend with strong weekly and annual patterns.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_010.png}\caption{Revenue distribution}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_011.png}\caption{Revenue boxplot by store}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_012.png}\caption{Quantity vs. revenue}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_013.png}\caption{Unit price vs. revenue}\end{subfigure}
\caption{Revenue and quantity analysis across store-segments.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_014.png}\caption{Revenue by region}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_015.png}\caption{Top states by revenue}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_017.png}\caption{Top products by revenue}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/eda_018.png}\caption{Revenue by category detail}\end{subfigure}
\caption{Geographic and product-level revenue breakdowns.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_revenue_distribution_boxplot.png}\caption{Revenue distribution boxplot}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_revenue_boxplot_by_segments.png}\caption{Revenue by segments}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_time_eda.png}\caption{Time-series EDA patterns}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_daily_revenue_rolling_mean.png}\caption{Daily revenue rolling mean}\end{subfigure}
\caption{Supplementary EDA: revenue distribution and time-series patterns.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_product_geography_eda.png}\caption{Product geography analysis}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_relationship_eda.png}\caption{Feature relationship analysis}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_numeric_correlation_heatmap.png}\caption{Numeric correlation heatmap}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_scatter_grid_features_vs_revenue.png}\caption{Feature scatter grid vs. revenue}\end{subfigure}
\caption{Feature relationships and correlation analysis.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_advanced_target_distribution.png}\caption{Advanced target distribution}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_density_original_vs_scaled.png}\caption{Density: original vs. scaled}\end{subfigure}
\caption{Target and feature distribution comparisons.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/loss_curves_log.png}\caption{Log-scale loss curves}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/monthly_revenue.png}\caption{Monthly revenue trend}\end{subfigure}
\caption{Loss curves (log scale) and monthly revenue patterns.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/predicted_vs_actual_model_a_with_quantity.png}\caption{Model A: predicted vs. actual}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/predicted_vs_actual_model_b_no_quantity.png}\caption{Model B: predicted vs. actual}\end{subfigure}
\caption{Actual vs. predicted scatter plots for both model variants.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residuals_model_a_with_quantity.png}\caption{Residuals: Model A}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residuals_model_b_no_quantity.png}\caption{Residuals: Model B}\end{subfigure}
\caption{Residual analysis — symmetric around zero confirms unbiased predictions.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residual_by_month_model_a_with_quantity.png}\caption{Residuals by month: Model A}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residual_by_month_model_b_no_quantity.png}\caption{Residuals by month: Model B}\end{subfigure}
\caption{Temporal residual patterns — error distribution across months.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residual_by_category_model_a_with_quantity.png}\caption{Residuals by category: Model A}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/residual_by_category_model_b_no_quantity.png}\caption{Residuals by category: Model B}\end{subfigure}
\caption{Category-level residuals — identifies which product families are hardest to forecast.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_model_b_actual_vs_predicted_line.png}\caption{Actual vs. predicted line plot}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_model_b_prediction_plots.png}\caption{Prediction analysis dashboard}\end{subfigure}
\caption{Model B diagnostics: line plot and prediction analysis.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_model_b_epsilon_tube_style.png}\caption{Epsilon-tube style plot}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_model_a_prediction_plots.png}\caption{Model A prediction plots}\end{subfigure}
\caption{Additional diagnostic views for both model variants.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_final_ridge_feature_weights.png}\caption{Ridge feature weights}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/notebook_full_eda_dashboard_like_sample.png}\caption{Full EDA dashboard}\end{subfigure}
\caption{Feature importance and comprehensive EDA dashboard.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/revenue_distribution.png}\caption{Revenue distribution histogram}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/revenue_boxplot.png}\caption{Revenue boxplot}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/revenue_by_region.png}\caption{Revenue by region}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/revenue_by_category.png}\caption{Revenue by category}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/quantity_distribution.png}\caption{Quantity distribution}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/quantity_vs_revenue.png}\caption{Quantity vs. revenue}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/unit_price_vs_revenue.png}\caption{Unit price vs. revenue}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab02/top_products_by_revenue.png}\caption{Top products by revenue}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{\textwidth}\centering\includegraphics[width=0.48\textwidth]{figures/lab02/top_states_by_revenue.png}\caption{Top states by revenue}\end{subfigure}
\caption{Revenue and quantity supplementary EDA plots.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/missing_values.png}\caption{Missing values per column}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/boxplots_before.png}\caption{Boxplots: original scale outliers}\end{subfigure}
\caption{Data quality checks: missing values and outlier detection via boxplots and IQR method.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/scatter_annual_income_vs_spending_score_before.png}\caption{Income vs. Spending Score}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/pairplot_before.png}\caption{Pairwise scatter matrix}\end{subfigure}
\caption{EDA before preprocessing: income-spending reveals 5 natural clusters; pairplot catches pairwise interactions.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/scatter_age_vs_spending_score_before.png}\caption{Age vs. Spending Score}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/scatter_age_vs_annual_income_before.png}\caption{Age vs. Annual Income}\end{subfigure}
\caption{Age-based scatter analysis: spending and income patterns by age group.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/distribution_age_before.png}\caption{Age distribution}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/distribution_annual_income_before.png}\caption{Annual income distribution}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/distribution_spending_score_before.png}\caption{Spending score distribution}\end{subfigure}
\caption{Feature distributions before preprocessing: age (uniform), income (right-skewed), spending (bimodal).}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/kmeans_elbow_curve.png}\caption{Elbow curve — bend at K=3–5}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/kmeans_silhouette_curve.png}\caption{Silhouette vs. K — peak at 5 clusters}\end{subfigure}
\caption{K-Means diagnostics: elbow and silhouette identify optimal cluster count.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/clusters_age_vs_spending_score.png}\caption{Age vs. Spending Score}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/clusters_age_vs_annual_income.png}\caption{Age vs. Annual Income}\end{subfigure}
\caption{Age-based cluster scatter plots: spending and income patterns across clusters.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/gmm_income_vs_spending.png}\caption{GMM on Income vs. Spending}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab03/gmm_contours.png}\caption{GMM covariance contours}\end{subfigure}
\caption{Gaussian Mixture Model: soft clustering with covariance ellipses showing cluster shape and orientation.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_picture.png}\caption{Original Picture 1}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_picture_2.png}\caption{Original Picture 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_picture_3.png}\caption{Original Picture 3}\end{subfigure}
\caption{Three RGB photographs used for image segmentation experiments.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_space_preview_picture.png}\caption{Color spaces: Picture 1}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_space_preview_picture_2.png}\caption{Color spaces: Picture 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_space_preview_picture_3.png}\caption{Color spaces: Picture 3}\end{subfigure}
\caption{RGB, HSV, LAB color space previews for all three images.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/silhouette_plot_picture_k5.png}\caption{Silhouette: Picture 1 at K=5}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/silhouette_plot_k5.png}\caption{Silhouette: K=5 detail}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/silhouette_plot_picture_2_k3.png}\caption{Silhouette: Picture 2 at K=3}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/silhouette_plot_picture_3_k5.png}\caption{Silhouette: Picture 3 at K=5}\end{subfigure}
\caption{Silhouette analysis across images and K values — thick, uniform bars indicate well-separated clusters.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_vs_segmented_picture.png}\caption{Original vs. Segmented: Pic 1}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_vs_segmented_picture_2.png}\caption{Original vs. Segmented: Pic 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.32\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/original_vs_segmented_picture_3.png}\caption{Original vs. Segmented: Pic 3}\end{subfigure}
\caption{Original vs. K=5 segmented reconstruction for all three images.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/elbow_plot_picture.png}\caption{Elbow: inertia vs. K — bend at K=3–5}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/convergence_plot_picture.png}\caption{Convergence: inertia decreases monotonically}\end{subfigure}
\caption{Diagnostic plots for optimal K selection}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/elbow_plot_picture_2.png}\caption{Elbow curve: Picture 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/elbow_plot_picture_3.png}\caption{Elbow curve: Picture 3}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/elbow_plot.png}\caption{Elbow curve: all pictures}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/k_comparison_grid.png}\caption{K-comparison grid}\end{subfigure}
\caption{Supplementary elbow and K-comparison diagnostic plots across all pictures.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/k_comparison_grid_picture_2.png}\caption{K-comparison: Picture 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/k_comparison_grid_picture_3.png}\caption{K-comparison: Picture 3}\end{subfigure}
\caption{K-comparison grids for pictures 2 and 3: original alongside K=2,3,5,8 segmentations.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/convergence_plot_picture_2.png}\caption{Convergence: Picture 2}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/convergence_plot_picture_3.png}\caption{Convergence: Picture 3}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/convergence_plot.png}\caption{Convergence: all pictures}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_palette_picture_k5.png}\caption{Color palette at K=5}\end{subfigure}
\caption{Convergence behavior and centroid color palette for segmented images.}
\end{figure}

\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_palette_picture_2_k3.png}\caption{Palette: Picture 2, K=3}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_palette_picture_3_k5.png}\caption{Palette: Picture 3, K=5}\end{subfigure}\\
\vspace{4pt}
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab31/color_palette_k5.png}\caption{Color palette K=5 detail}\end{subfigure}
\caption{Centroid color palettes — each swatch represents a cluster's representative color. Muddy swatches indicate averaging dissimilar colors.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_02_feature_distributions.png}\caption{Feature distributions}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_03_target_distribution.png}\caption{Target distribution}\end{subfigure}
\caption{Feature and target distributions — right-skewed count features, target capped at \$500,006.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_06_correlation_heatmap.png}\caption{Correlation heatmap}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_07_target_correlation_bar.png}\caption{Target correlation bar chart}\end{subfigure}
\caption{Correlation analysis: \texttt{median\_income} dominates ($r \approx 0.69$); no other feature exceeds $|r| > 0.3$.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_08_scatter_matrix.png}\caption{Scatter matrix}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_09_income_vs_price.png}\caption{Income vs. price}\end{subfigure}
\caption{Scatter matrix and income-price relationship — positive trend with capped ceiling at \$500,006.}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_10_ocean_proximity_bar.png}\caption{Ocean proximity bar chart}\end{subfigure}\hfill
\begin{subfigure}[b]{0.48\textwidth}\centering\includegraphics[width=\textwidth]{figures/lab04/eda_11_ocean_proximity_boxplot.png}\caption{Ocean proximity boxplot}\end{subfigure}
\caption{Ocean proximity analysis: \texttt{<1H OCEAN} and \texttt{NEAR BAY} have highest prices; \texttt{INLAND} is cheapest.}
\end{figure}
